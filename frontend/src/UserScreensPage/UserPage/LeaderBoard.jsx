          ...
          postdata.map((item) => (
            ...
            >
              ...
              <div className="bg-[#2D2D2D] p-4 rounded-xl mb-4">
                <h3 className="capitalize text-xl text-white  flex items-center gap-x-0.5"><i className="text-yellow-500 ri-hashtag"></i>{item.compId?.topicName}</h3>
