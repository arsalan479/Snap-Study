      ...
      <div className="w-full max-w-xl mx-auto bg-[#1f1f1f] text-white p-10 rounded-xl shadow-md space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold">
              {userfetch.displayName}{" "}
              <span>
                <UserNameModal />
              </span>{" "}
            </h1>
            <p className="text-sm text-gray-400">
              Joined on: {format(createDate, "dd MMMM yyyy")} (
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between border-b border-gray-700 pb-2">
            ...
            <span className="text-[#3468f5] font-medium">
              {userfetch.Plans}
            </span>
          </div>
          <div className="flex justify-between border-b border-gray-700 pb-2">
            <span className="text-gray-400">Per Day Credits</span>
            <span className="text-[#fff] font-medium">{userfetch.credits}</span>
          </div>
          <div className="flex justify-between border-b border-gray-700 pb-2">
            <span className="text-gray-400">Account</span>
            <button
              onClick={opendeletemodel}
              className="bg-red-500 text-white font-medium cursor-pointer hover:bg-red-400  duration-300 rounded-[10px] py-2 px-4"
            >
              Delete Account
            </button>
          </div>
